...
<!-- Mirrored from www.radiustheme.com/demo/html/newsedge/newsedge/post-style-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 18 Jan 2022 01:21:15 GMT -->
...
<body>
    ...
    <div id="wrapper" class="wrapper">
        ...
        <section class="breadcrumbs-area"
            style="background-image: url('<?=base_url();?>/assets/img/banner/breadcrumbs-banner.jpg');">
            <div class="container">
                                    ...
                                    <li>
                                        <div class="media">
                                            <a href="post-style-1.html">
                                                <img src="<?=base_url();?>/assets/img/footer/post1.jpg" alt="post"
                                                    class="img-fluid">
                                            </a>
                                    ...
                                    <li>
                                        <div class="media">
                                            <a href="post-style-2.html">
                                                <img src="<?=base_url();?>/assets/img/footer/post2.jpg" alt="post"
                                                    class="img-fluid">
                                            </a>
                                            <div class="media-body">
                                                <h3 class="title-medium-light size-md mb-10">
                                    ...
                                    <li>
                                        <div class="media">
                                            <a href="post-style-3.html">
                                                <img src="<?=base_url();?>/assets/img/footer/post3.jpg" alt="post"
                                                    class="img-fluid">
                                            </a>
                                            <div class="media-body">
                                                <h3 class="title-medium-light size-md mb-10">
                                ...
                                <ul class="post-gallery shine-hover ">
                                    <li>
                                        <a href="gallery-style1.html">
                                            <figure>
                                                <img src="<?=base_url();?>/assets/img/footer/post4.jpg" alt="post"
                                                    class="img-fluid">
                                            </figure>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="gallery-style2.html">
                                            <figure>
                                                <img src="<?=base_url();?>/assets/img/footer/post5.jpg" alt="post"
                                                    class="img-fluid">
                                            </figure>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="gallery-style1.html">
                                            <figure>
                                                <img src="<?=base_url();?>/assets/img/footer/post6.jpg" alt="post"
                                                    class="img-fluid">
                                            </figure>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="gallery-style2.html">
                                            <figure>
                                                <img src="<?=base_url();?>/assets/img/footer/post7.jpg" alt="post"
                                                    class="img-fluid">
                                            </figure>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="gallery-style1.html">
                                            <figure>
                                                <img src="<?=base_url();?>/assets/img/footer/post8.jpg" alt="post"
                                                    class="img-fluid">
                                            </figure>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="gallery-style2.html">
                                            <figure>
                                                <img src="<?=base_url();?>/assets/img/footer/post9.jpg" alt="post"
                                                    class="img-fluid">
                                            </figure>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="gallery-style1.html">
                                            <figure>
                                                <img src="<?=base_url();?>/assets/img/footer/post10.jpg" alt="post"
                                                    class="img-fluid">
                                            </figure>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="gallery-style2.html">
                                            <figure>
                                                <img src="<?=base_url();?>/assets/img/footer/post11.jpg" alt="post"
                                                    class="img-fluid">
                                            </figure>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="gallery-style1.html">
                                            <figure>
                                                <img src="<?=base_url();?>/assets/img/footer/post12.jpg" alt="post"
                                                    class="img-fluid">
                                            </figure>
                                        </a>
                                    </li>
    ...
    <!-- Ticker Js -->
    <script src="<?=base_url();?>/assets/js/ticker.js" type="text/javascript"></script>
    <!-- Custom Js -->
